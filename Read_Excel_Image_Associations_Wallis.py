...
fpath = "C:\Work\Tableau Projects\Wallis\Image_Associations\Ages_40-54\\"
...
Competitor_Set = ['Wallis','Next','Primark','Marks & Spencer','Asda','Debenhams','Tesco','Dorothy Perkins','John Lewis','House of Fraser','Phase Eight','Warehouse','Cos','Hobbs','Monsoon','Zara','Oasis']
#Metric in focus
Metric_Concerned ="PF_Instore_L12M"
print(len(Competitor_Set))
...
reg_output_df.to_excel("reg_output_" + Competitor_Set[0] + "_"+ Metric_Concerned + "_Ages_40-54" +".xlsx")


'''
#Following code gets the rankings
...
dataframe.to_excel(Competitor_Set[0] + "_Latest_Metric_For_Plotting.xlsx")
'''
