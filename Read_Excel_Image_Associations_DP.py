...
Competitor_Set = ['Dorothy Perkins', 'Primark', 'Tesco','Marks & Spencer','H&M','Asda','New Look','Zara','Next','Debenhams']
#Metric in focus
...
dataframe = dataframe.groupby('Data').sum()/10#Divide by 10 competitor set to get average
