...
Focus_Brand = "Wallis" #Update this before the program is run
...
Satisfaction_Result = ['In_store_satisfaction', 'Online_satisfaction']

#Query the competitor set with the required conditions. Update this before the program is run
Query = "select * \
from a_temp.DSS_Brand_Satisfaction_UK where Retailer in (111, 10,25,26,29,45,54,63,70,74,77,80,82,98,112,116) and Age >= 40 and Age <= 54"
print(Query)
