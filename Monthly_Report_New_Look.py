...
fpath = "C:\Work\Barometer\June_5th\UK\\"#Folder where metric files from morar are stored
root, dirs, files = os.walk(fpath).next()
#Update these dates to get the required two months
Months = ["31/05/2018","30/04/2018", "31/03/2018", "28/02/2018", "31/01/2018", "31/12/2017", "30/11/2017", "31/10/2017", "30/09/2017", "31/08/2017", "31/07/2017", "30/06/2017", "31/05/2017", "30/04/2017", "31/03/2017"]
...
dfbrand=pd.read_excel("Select_New_Look_Metrics.xlsx",0,index_col=False)
dfbrand = dfbrand[dfbrand.Select==1]
dfbrand.reset_index(level=0, inplace=True)

dfmetric=pd.read_excel("Select_New_Look_Metrics.xlsx",1,index_col=False)
...
dfoutput.to_excel("Metrics_New_Look2.xlsx")
