...
fpath = "C:\Work\Tableau Projects\Evans-Revised_Competitor_Set\Image_Associations\Ages_25-39_Size_16-22\\"
...
Competitor_Set = ['Evans','Marks & Spencer','Next','Very','SimplyBe','New Look','H&M','Yours','JD Williams','Dorothy Perkins','ASOS']
...
reg_output_df.to_excel("reg_output_" + Competitor_Set[0] + "_"+ Metric_Concerned + "_Ages_25-39" +".xlsx")
'''
...
dataframe.to_excel(Competitor_Set[0] + "_Latest_Metric_For_Plotting_Ages_25-39.xlsx")
