...
fpath = "C:\Work\Tableau Projects\Evans\Image_Associations\Ages_40-74_Size_16-22\\"
...
Competitor_Set = ['Evans','Marks & Spencer','Next','Very','SimplyBe','New Look','H&M','Yours','JD Williams','Dorothy Perkins',]
#Metric in focus
...
reg_output_df.to_excel("reg_output_" + Competitor_Set[0] + "_"+ Metric_Concerned + "_Ages_40-74" +".xlsx")
...
dataframe.to_excel(Competitor_Set[0] + "_Latest_Metric_For_Plotting_Ages_40-74.xlsx")
'''
