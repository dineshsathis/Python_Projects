...
fpath = "C:\Work\Tableau Projects\New_Look\Image_Associations\Ages_18-34_Monthly\\"
...
#Code to get the data for multiple days

Column_List = ['Brand', 'Data', '31/03/2017','30/04/2017','31/05/2017', '31/03/2018','30/04/2018','31/05/2018']
...
dataframe['index'] = np.arange(len(dataframe))
dataframe = dataframe.set_index('index')
dataframe.to_excel(Competitor_Set[0] + "_Month_End_Days" + "_For_Plotting_Ages_18-34.xlsx")
