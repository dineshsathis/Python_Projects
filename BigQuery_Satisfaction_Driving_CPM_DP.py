...
Query = "select * \
from a_temp.DSS_Brand_Satisfaction_UK where Retailer in (98,29,63,41,82,10,73,116,74,26) and Age >= 25 and Age <= 54"
...
reg_output_df.to_excel("reg_output_Satisfaction_Driver_CPMs_DP.xlsx")